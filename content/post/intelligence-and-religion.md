...
شاید یه مثال، بهتر قضیه رو روشن کنه. فرض کنید که چشم نوزاد شروع به دریافت بازهٔ خاصی از امواج الکترومغناطیس می‌کنه. این بازه، مربوط به رنگ نارنجیه. با فرض اینکه الگوهای رنگ‌های مجاور نارنجی مثل زرد و قرمز پیش‌تر شکل گرفته، نوزاد شروع به درک مبهم چیزی بین زرد یا قرمز می‌کنه. این موضوع بستگی داره که بازهٔ موجِ دریافتی نزدیک به کدوم طرف طیف باشه. با تکرار دریافت، درک نوزاد از رنگ نارنجی شفاف‌تر و الگوی ساخته شده دقیق‌تر میشه. این موضوع تا جایی پیش میره که نوزاد درک کاملا متفاوتی از رنگ نارنجی نسبت به رنگ‌های همجوارش در طیف نوری پیدا می‌کنه.
...
> بی‌سوادِ قرنِ بیست و یکی، کسی نیست که نمی‌تونه بخونه یا بنویسه، بلکه کسیه که نمی‌تونه یاد بگیره (learn)، یاد گرفته‌هاش رو فراموش کنه (unlearn)، و دوباره یاد بگیره (relearn).

تعمیمش به هوش میشه: 

> انسانِ باهوش کسیه که می‌تونه الگوها و باورهایی که یاد گرفته رو راستی‌آزمایی کنه، اگه اشتباه بود کنار بگذاره، و الگوها و باورهای بهتر با قابلیت پیش‌بینی دقیق‌تر رو جایگزین باورهای غلط کنه.
...
پس پذیرش خطا، اصلاح و پیدا کردن الگوهای صحیح‌تر معنایی جز باهوش‌تر بودن نداره. و ناتوانی و تعصب روی الگوهای ایراددار و عدم پذیرش و اصلاح معنایی جز کم‌هوش‌تر بودن نداره.


## الگوها و علم
روابط پیچیدهٔ اجتماعیِ ما به الگوهایی فراتر و نرم‌تر نیاز داره. یه سری از این الگوها به واسطهٔ سخت‌افزارهایی که طبیعت توی وجود ما ساخته به صورت خودکار و به مرور ساخته میشه. مثلا برای دیدن، لازم نیست که بشینید و یاد بگیرید که چطوری کدوم بازه از فرکانس‌ها رو به چه رنگی ببینید. این عملیات خیلی پیچیده و یه جورایی غیرممکنٔ به صورت خودکار از بدو تولد شروع میشه و ادامه پیدا می‌کنه. 

ولی درک دنیا برای ساخت رابطه‌ها، ابزار و در یک کلام جوامع به شکلی که امروزه می‌بینیم، نیاز به الگوهایی داره که ما رو به هدف برسونه. این الگوها خودشون رو در قالب قوانین، نظریه‌ها و فرضیه‌ها نشون می‌دن.

**اگه روی این موضوع توافق داشته باشیم که الگوهایی که توانایی پیش‌بینی دقیق‌تری نسبت به دیگر الگوها دارند، الگوهای بهتری هم هستند، ما در حقیقت به علم سلام گفتیم.** به این رویکرد، علم می‌گیم، و چنانچه با روش علمی مخالف باشید، در حقیقت با گزارهٔ بدیهی (و پُررنگِ) بالا مخالفت کردید. 

کار علم، که دنیای ما رو به این سطح از پیشرفت و پیچیدگی رسونده، دقیقا همینه. علم، ابتدا بر اساس رفتارها، کُنش‌ها و واکنش‌های پدیده‌ها، مشاهداتش رو ثبت و فرضیه‌ای رو مطرح می‌کنه. این فرضیه، همون الگوی اولیه‌ست. 
...
بحث یافتن الگوها، همونطور که دیدید، فقط مختص علم نیست، بلکه طبیعتِ زیست و زیست‌شناسیه. روش علمی فعلا بهترین روش برای پیدا کردن الگوها به حساب میاد. اگه شما فکر می‌کنید که روش دیگه‌ای (مثل روش دینی و «الهامات الهی») بهتر از علم الگوها رو می‌سازند، قدم جلو بذارید و ثابت کنید. جامعهٔ علمی برخلاف جوامع مذهبی، نسبت به تغییر باز و پذیراست.
 ...
 در گذشتهٔ نه‌چندان دور، این دین و مذهب بوده که الگوها رو تعریف می‌کرده. و حتی قبل از اون، بشر همیشه به دنبال درک چرایی پدیده‌ها و ساخت الگو برای پیش‌بینی اون‌ها بوده.
...
به عبارت ساده‌تر دینْ خودش نسخهٔ تکامل‌یافته از قوانین ابتداییِ بشر برای ساخت گروه‌ها و قبیله‌ها بود. هرچقدر جوامع بزرگ‌تر و پیچیده‌تر می‌شد، نیاز به الگوهایی برای کنار هم قرار دادن این جوامع بیشتر و بیشتر احساس می‌شد.
...
اگر به تست هوش بگردیم، شاید بهتر متوجه بشید که یه فرد باهوش کیه؟ اونی که اگه الگوی اشتباهی رو انتخاب کرد، توانایی درک اشتباه، بازگشت به صورت مساله و انتخاب الگوی درست‌تر رو داشته باشه. به عبارت ساده‌تر کسی که توانایی به‌روزرسانی و بهبود و تکامل باورهاش رو داشته باشه.
...
اینجاست که یه آدم باهوش به خودش میاد، سوگیری تاییدی رو خنثی می‌کنه، و بی‌طرفانه به باورها و الگوها نگاه می‌اندازه. وقتی این باورها نه‌تنها با هم تناقض دارند،‌ که در مقایسه با الگوهای علمی گُنگ‌تر، و ناقص‌تر هستند رو می‌بینه، و خودش و باورهاش رو به‌روز می‌کنه.
...
به نظر من، ذهن بچه‌ای که امروزه به دنیا میاد، آمادگی بیشتری داره تا الگوهای مشکل‌داره رو تغییر بده یا تخریب کنه، و به جاش الگوهای دقیق‌تر و بهتر رو قرار بده. همون چیزی که من طی این مقاله به عنوان هوش معرفیش کردم.
