...
همهٔ این فرضیه‌ها و ایده‌ها خوب نیستند، بلکه گاهی می‌تونند محل تولد مکتب‌های بسیار خطرناکی بشن، به همین خاطر بایستی با تکیه بر تجربیات، آزمون و خطا، و فلسفیدن در خصوص این ایده‌ها، به مجموعه الگوها و روش‌هایی برای اداره جامعه برسیم که منفعتشون بیشتر از ضررشون باشه. 
...
اما به سراغ روش علمی بریم. **اگه روی این موضوع توافق داشته باشیم که الگوهایی که توانایی پیش‌بینی دقیق‌تری نسبت به دیگر الگوها دارند، الگوهای بهتری هم هستند، ما در حقیقت به علم سلام گفتیم.** به این رویکرد، علم می‌گیم، و چنانچه با روش علمی مخالف باشید، در حقیقت با گزارهٔ بدیهی (و پُررنگِ) بالا مخالفت کردید. 
...
اگر به تست هوش بگردیم، شاید بهتر متوجه بشید که یه فرد باهوش کیه؟ اونی که اگه الگوی اشتباهی رو انتخاب کرد، توانایی درک اشتباه، بازگشت به صورت مساله و انتخاب الگوی درست‌تر رو داشته باشه. به عبارت ساده‌تر کسی که توانایی مشاهدهٔ بی‌طرفانه، به‌روزرسانی، بهبود و تکامل باورهاش رو داشته باشه.
