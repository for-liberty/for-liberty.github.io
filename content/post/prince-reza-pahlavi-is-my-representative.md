...
تلگرام از این جهت خوبه،‌ که با وضع افتضاحِ نت، باز هم یه سری پروکسی‌ها جواب می‌دن، و مردم بیشتری ازش استفاده می‌کنند. از طرفی شبیه به یه رسانهٔ تخصصی‌تر مثل توییتر نیست، که جامعهٔ هدفِ خاص‌تری داشته باشه.

یا نظرسنجی‌های مشابه روی توییتر:
